...
static inline void sys_cons_write_char(int ch) {
  syscall(SYS_CONS_WRITE_CHAR, ch, 0, 0, 0, 0, 0, 0);
}

static inline int sys_cons_read_char(void) {
  return syscall(SYS_CONS_READ_CHAR, 0, 0, 0, 0, 0, 0, 0);
}

static inline void sys_cons_write_buf(const char *buf, size_t len) {
...
sys_get_partition_status(PARTITION_STATUS_TYPE *partition_status) {
  return syscall(SYS_GET_PARTITION_STATUS, (unsigned long)partition_status, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_set_partition_mode(OPERATING_MODE_TYPE operating_mode) {
  return syscall(SYS_SET_PARTITION_MODE, operating_mode, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_process_id(PROCESS_NAME_TYPE process_name,
                                                  PROCESS_ID_TYPE *process_id) {
  return syscall(SYS_GET_PROCESS_ID, (unsigned long)process_name, (unsigned long)process_id, 0,
                 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_process_status(PROCESS_ID_TYPE process_id,
                                                      PROCESS_STATUS_TYPE *process_status) {
  return syscall(SYS_GET_PROCESS_STATUS, process_id, (unsigned long)process_status, 0, 0, 0, 0,
                 0);
}

static inline RETURN_CODE_TYPE sys_create_process(PROCESS_ATTRIBUTE_TYPE *attributes,
                                                  PROCESS_ID_TYPE *process_id) {
  return syscall(SYS_CREATE_PROCESS, (unsigned long)attributes, (unsigned long)process_id, 0, 0,
                 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_set_priority(PROCESS_ID_TYPE process_id,
                                                PRIORITY_TYPE priority) {
  return syscall(SYS_SET_PRIORITY, process_id, priority, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_suspend_self(SYSTEM_TIME_TYPE time_out) {
  return syscall(SYS_SUSPEND_SELF, time_out, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_suspend(PROCESS_ID_TYPE process_id) {
  return syscall(SYS_SUSPEND, process_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_resume(PROCESS_ID_TYPE process_id) {
...
static inline RETURN_CODE_TYPE sys_start(PROCESS_ID_TYPE process_id) {
  return syscall(SYS_START, process_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_delayed_start(PROCESS_ID_TYPE process_id,
                                                 SYSTEM_TIME_TYPE delay_time) {
  return syscall(SYS_DELAYED_START, process_id, delay_time, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_lock_preemption(LOCK_LEVEL_TYPE *lock_level) {
  return syscall(SYS_LOCK_PREEMPTION, (unsigned long)lock_level, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_unlock_preemption(LOCK_LEVEL_TYPE *lock_level) {
  return syscall(SYS_UNLOCK_PREEMPTION, (unsigned long)lock_level, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_my_id(PROCESS_ID_TYPE *process_id) {
...
static inline RETURN_CODE_TYPE
sys_get_my_processor_core_id(PROCESSOR_CORE_ID_TYPE *processor_core_id) {
  return syscall(SYS_GET_MY_PROCESSOR_CORE_ID, (unsigned long)processor_core_id, 0, 0, 0, 0, 0,
                 0);
}

static inline RETURN_CODE_TYPE sys_get_my_index(PROCESS_INDEX_TYPE *process_index) {
  return syscall(SYS_GET_MY_INDEX, (unsigned long)process_index, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_timed_wait(SYSTEM_TIME_TYPE delay_time) {
  return syscall(SYS_TIMED_WAIT, delay_time, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_periodic_wait(void) {
  return syscall(SYS_PERIODIC_WAIT, 0, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_time(SYSTEM_TIME_TYPE *system_time) {
  return syscall(SYS_GET_TIME, (unsigned long)system_time, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_replenish(SYSTEM_TIME_TYPE budget_time) {
  return syscall(SYS_REPLENISH, budget_time, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE
sys_create_sampling_port(SAMPLING_PORT_NAME_TYPE sampling_port_name,
                         MESSAGE_SIZE_TYPE max_message_size, PORT_DIRECTION_TYPE port_direction,
...
static inline RETURN_CODE_TYPE
sys_write_sampling_message(SAMPLING_PORT_ID_TYPE sampling_port_id,
...
static inline RETURN_CODE_TYPE sys_read_sampling_message(SAMPLING_PORT_ID_TYPE sampling_port_id,
...
static inline RETURN_CODE_TYPE
sys_get_sampling_port_id(SAMPLING_PORT_NAME_TYPE sampling_port_name,
                         SAMPLING_PORT_ID_TYPE *sampling_port_id) {
...
static inline RETURN_CODE_TYPE
sys_get_sampling_port_status(SAMPLING_PORT_ID_TYPE sampling_port_id,
...
static inline RETURN_CODE_TYPE sys_create_queuing_port(
    QUEUING_PORT_NAME_TYPE queuing_port_name, MESSAGE_SIZE_TYPE max_message_size,
    MESSAGE_RANGE_TYPE max_nb_message, PORT_DIRECTION_TYPE port_direction,
    QUEUING_DISCIPLINE_TYPE queuing_discipline, QUEUING_PORT_ID_TYPE *queuing_port_id) {
...
static inline RETURN_CODE_TYPE sys_send_queuing_message(QUEUING_PORT_ID_TYPE queuing_port_id,
                                                        MESSAGE_ADDR_TYPE message_addr,
                                                        MESSAGE_SIZE_TYPE length,
...
static inline RETURN_CODE_TYPE sys_receive_queuing_message(QUEUING_PORT_ID_TYPE queuing_port_id,
                                                           SYSTEM_TIME_TYPE time_out,
                                                           MESSAGE_ADDR_TYPE message_addr,
                                                           MESSAGE_SIZE_TYPE *length) {
...
static inline RETURN_CODE_TYPE sys_get_queuing_port_id(QUEUING_PORT_NAME_TYPE queuing_port_name,
...
static inline RETURN_CODE_TYPE
sys_get_queuing_port_status(QUEUING_PORT_ID_TYPE queuing_port_id,
...
static inline RETURN_CODE_TYPE sys_clear_queuing_port(QUEUING_PORT_ID_TYPE queuing_port_id) {
  return syscall(SYS_CLEAR_QUEUING_PORT, queuing_port_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_create_buffer(BUFFER_NAME_TYPE buffer_name,
...
static inline RETURN_CODE_TYPE sys_send_buffer(BUFFER_ID_TYPE buffer_id,
                                               MESSAGE_ADDR_TYPE message_addr,
                                               MESSAGE_SIZE_TYPE length,
                                               SYSTEM_TIME_TYPE time_out) {
...
static inline RETURN_CODE_TYPE sys_receive_buffer(BUFFER_ID_TYPE buffer_id,
                                                  SYSTEM_TIME_TYPE time_out,
                                                  MESSAGE_ADDR_TYPE message_addr,
                                                  MESSAGE_SIZE_TYPE *length) {
...
static inline RETURN_CODE_TYPE sys_get_buffer_id(BUFFER_NAME_TYPE buffer_name,
                                                 BUFFER_ID_TYPE *buffer_id) {
  return syscall(SYS_GET_BUFFER_ID, (unsigned long)buffer_name, (unsigned long)buffer_id, 0, 0,
                 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_buffer_status(BUFFER_ID_TYPE buffer_id,
                                                     BUFFER_STATUS_TYPE *buffer_status) {
  return syscall(SYS_GET_BUFFER_STATUS, buffer_id, (unsigned long)buffer_status, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_create_blackboard(BLACKBOARD_NAME_TYPE blackboard_name,
                                                     MESSAGE_SIZE_TYPE max_message_size,
...
static inline RETURN_CODE_TYPE sys_display_blackboard(BLACKBOARD_ID_TYPE blackboard_id,
                                                      MESSAGE_ADDR_TYPE message_addr,
                                                      MESSAGE_SIZE_TYPE length) {
...
static inline RETURN_CODE_TYPE sys_read_blackboard(BLACKBOARD_ID_TYPE blackboard_id,
                                                   SYSTEM_TIME_TYPE time_out,
                                                   MESSAGE_ADDR_TYPE message_addr,
                                                   MESSAGE_SIZE_TYPE *length) {
...
static inline RETURN_CODE_TYPE sys_clear_blackboard(BLACKBOARD_ID_TYPE blackboard_id) {
  return syscall(SYS_CLEAR_BLACKBOARD, blackboard_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_blackboard_id(BLACKBOARD_NAME_TYPE blackboard_name,
                                                     BLACKBOARD_ID_TYPE *blackboard_id) {
...
static inline RETURN_CODE_TYPE
sys_get_blackboard_status(BLACKBOARD_ID_TYPE blackboard_id,
...
static inline RETURN_CODE_TYPE sys_create_semaphore(SEMAPHORE_NAME_TYPE semaphore_name,
...
static inline RETURN_CODE_TYPE sys_wait_semaphore(SEMAPHORE_ID_TYPE semaphore_id,
                                                  SYSTEM_TIME_TYPE time_out) {
  return syscall(SYS_WAIT_SEMAPHORE, semaphore_id, time_out, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_signal_semaphore(SEMAPHORE_ID_TYPE semaphore_id) {
  return syscall(SYS_SIGNAL_SEMAPHORE, semaphore_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_semaphore_id(SEMAPHORE_NAME_TYPE semaphore_name,
                                                    SEMAPHORE_ID_TYPE *semaphore_id) {
...
static inline RETURN_CODE_TYPE
sys_get_semaphore_status(SEMAPHORE_ID_TYPE semaphore_id,
...
static inline RETURN_CODE_TYPE sys_create_event(EVENT_NAME_TYPE event_name,
                                                EVENT_ID_TYPE *event_id) {
  return syscall(SYS_CREATE_EVENT, (unsigned long)event_name, (unsigned long)event_id, 0, 0, 0,
                 0, 0);
}

static inline RETURN_CODE_TYPE sys_set_event(EVENT_ID_TYPE event_id) {
  return syscall(SYS_SET_EVENT, event_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_reset_event(EVENT_ID_TYPE event_id) {
  return syscall(SYS_RESET_EVENT, event_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_wait_event(EVENT_ID_TYPE event_id,
                                              SYSTEM_TIME_TYPE time_out) {
  return syscall(SYS_WAIT_EVENT, event_id, time_out, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_event_id(EVENT_NAME_TYPE event_name,
                                                EVENT_ID_TYPE *event_id) {
  return syscall(SYS_GET_EVENT_ID, (unsigned long)event_name, (unsigned long)event_id, 0, 0, 0,
                 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_event_status(EVENT_ID_TYPE event_id,
                                                    EVENT_STATUS_TYPE *event_status) {
  return syscall(SYS_GET_EVENT_STATUS, event_id, (unsigned long)event_status, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_create_mutex(MUTEX_NAME_TYPE mutex_name,
...
static inline RETURN_CODE_TYPE sys_acquire_mutex(MUTEX_ID_TYPE mutex_id,
                                                 SYSTEM_TIME_TYPE time_out) {
  return syscall(SYS_ACQUIRE_MUTEX, mutex_id, time_out, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_release_mutex(MUTEX_ID_TYPE mutex_id) {
  return syscall(SYS_RELEASE_MUTEX, mutex_id, 0, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_reset_mutex(MUTEX_ID_TYPE mutex_id,
                                               PROCESS_ID_TYPE process_id) {
  return syscall(SYS_RESET_MUTEX, mutex_id, process_id, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_mutex_id(MUTEX_NAME_TYPE mutex_name,
                                                MUTEX_ID_TYPE *mutex_id) {
  return syscall(SYS_GET_MUTEX_ID, (unsigned long)mutex_name, (unsigned long)mutex_id, 0, 0, 0,
                 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_mutex_status(MUTEX_ID_TYPE mutex_id,
                                                    MUTEX_STATUS_TYPE *mutex_status) {
  return syscall(SYS_GET_MUTEX_STATUS, mutex_id, (unsigned long)mutex_status, 0, 0, 0, 0, 0);
}

static inline RETURN_CODE_TYPE sys_get_process_mutex_state(PROCESS_ID_TYPE process_id,
                                                           MUTEX_ID_TYPE *mutex_id) {
